...
class Trainer(DefaultTrainer):
    ...
    def build_model(cls, cfg):
        ...
        for name, param in model.named_parameters():
            if (
                ...
                or "semantic_csi_gate" in name.lower()
    ...
    def build_optimizer(cls, cfg, model):
        """
        Give randomly initialized WiFo-side modules a larger learning rate while
        keeping the detector/backbone relatively stable.
        """
        base_lr = cfg.SOLVER.BASE_LR
        weight_decay = cfg.SOLVER.WEIGHT_DECAY

        wifo_lr_mult = float(getattr(cfg.MODEL.MIMO, "WIFO_LR_MULT", 5.0))
        adapter_lr_mult = float(getattr(cfg.MODEL.MIMO, "WIFO_ADAPTER_LR_MULT", 10.0))
        ...
        for name, param in model.named_parameters():
            ...
            if "backbone.wifo_adapter" in name or "backbone.semantic_csi_gate" in name:
                lr = base_lr * adapter_lr_mult
            ...
            if (
                ...
                or "backbone.semantic_csi_gate" in name
